...
class ChargementCOR : public Chargement
{
	ChargementCOR* _suivant;
...
public:
	...
	*/
	ChargementCOR(ChargementCOR* suivant);
	...
	*/
	Forme* resoudre(const string& idForme, const string& info = "")const;
