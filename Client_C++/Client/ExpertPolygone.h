...
class ExpertPolygone : public ChargementCOR
{
public:
	...
	*/
	ExpertPolygone(ChargementCOR* suivant);

	/**
	* \brief Retourne le type de la forme que l'expert peut traiter (ici un polygone)
