...
int main()
{
	try
	{
		...
		Vecteur2D v2(300, 400), v3(350, 350), v4(150, 120), v5(350, 30), v6(490, 190);
		...
		Segment segment(Vecteur2D(350, 30), Vecteur2D(490, 190), GREEN);
		Triangle triangle(Vecteur2D(250, 400), Vecteur2D(200, 500), Vecteur2D(300, 500), BLACK);
		Cercle cercle(Vecteur2D(490, 190), 50, GREEN);
		Polygone polygone(CYAN);
		polygone.ajouter(Vecteur2D(350, 400));
		polygone.ajouter(Vecteur2D(450, 400));
		polygone.ajouter(Vecteur2D(550, 500));
		polygone.ajouter(Vecteur2D(450, 600));
		polygone.ajouter(Vecteur2D(350, 600));

		VisiteurRotation rotaTriangle(triangle.getCentreGravite(), PI);
		//VisiteurTranslation translationTriangle(triangle.getCentreGravite(), Vecteur2D())


		Groupe groupe(RED);
		
		segment.accepte(dessin);
	
		//triangle.accepte(dessin);

		//cercle.accepte(dessin);
